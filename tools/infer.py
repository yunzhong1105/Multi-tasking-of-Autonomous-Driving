...
def get_args_parser(add_help=True):
    ...
    parser.add_argument('--conf-thres', type=float, default=0.20, help='confidence threshold for inference.')
    parser.add_argument('--iou-thres', type=float, default=0.9, help='NMS IoU threshold for inference.')
...
def run(weights=osp.join(ROOT, 'yolov6s.pt'),
    ...
    inferer.infer(conf_thres, iou_thres, classes, agnostic_nms, max_det, save_dir, save_txt, not not_save_img, save_seg, hide_labels, hide_conf, view_img)
