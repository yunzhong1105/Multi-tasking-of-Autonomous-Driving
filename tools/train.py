...
def get_args_parser(add_help=True):
    ...
    parser.add_argument('--skip', type=str,default="False", help='resume the most recent training')
    ...
    parser.add_argument('--freeze_backbone', default=0, type=int, help='')
...
#     import pdb
#     pdb.set_trace()
    skip = True if args.skip=='True' else False
    detonly, segonly, clsonly = args.detonly, args.segonly, args.clsonly
...
#         else:
        ...
        args.detonly, args.segonly, args.clsonly = detonly, segonly, clsonly
    else:
        args.save_dir = str(increment_name(osp.join(args.output_dir, args.name)))
        # print("#"*80)
        # print("save dir :\n" , args.save_dir)
        # print("master_process :\n" , master_process)
        # print("resume :\n" , args.resume)
        # print("#"*80)
        # assert 1 == 2
...
#     pdb.set_trace()
    ...
    # wandb.init(project = "cvpr-project" , config = args)
    ...
    # print(args.quant , args.calib) --> False , False
